...
const texts = {
    en: {
        ...
        autostartError: "Failed to update startup settings. Antivirus might be blocking it."
    },
    ar: {
        ...
        autostartError: "فشل تحديث إعدادات بدء التشغيل. قد يكون برنامج الحماية يمنع ذلك."
    }
};
...
function updateUIText(){
    ...
    // Pomodoro modal text
    pomodoroModal.querySelector('h3').textContent = texts[currentLang].pomodoroTitle;
    pomodoroModal.querySelector('label[for="pomoWork"]').textContent = texts[currentLang].studyLabel;
    pomodoroModal.querySelector('label[for="pomoShort"]').textContent = texts[currentLang].shortBreakLabel;
    pomodoroModal.querySelector('label[for="pomoLong"]').textContent = texts[currentLang].longBreakLabel;
    pomodoroModal.querySelector('label[for="pomoCycles"]').textContent = texts[currentLang].cyclesLabel;
    pomoOkBtn.textContent = texts[currentLang].modalOk;

    // Settings modal text
    settingsModal.querySelector('h3').textContent = texts[currentLang].settingsTitle;
    document.getElementById('langSelectLabel').textContent = texts[currentLang].langSelectLabel;
    ...
    // Settings labels
    document.querySelector('label[for="soundType"]').textContent = texts[currentLang].soundTypeLabel;
    document.querySelector('label[for="freq"]').textContent = texts[currentLang].freqLabel;
    document.querySelector('label[for="volume"]').textContent = texts[currentLang].volumeLabel;
    document.querySelector('#customFile').previousElementSibling.textContent = texts[currentLang].uploadLabel;
    ...
    document.querySelector('option[value="birds"]').textContent = texts[currentLang].birds;
    document.querySelector('option[value="piano"]').textContent = texts[currentLang].piano;
    document.querySelector('option[value="magic"]').textContent = texts[currentLang].magic;

    document.getElementById('sineOption').textContent = texts[currentLang].sineOption;
    document.getElementById('triangleOption').textContent = texts[currentLang].triangleOption;
    document.getElementById('squareOption').textContent = texts[currentLang].squareOption;
    document.getElementById('sawtoothOption').textContent = texts[currentLang].sawtoothOption;
}
...
autostartToggle.addEventListener('change', async ()=>{
    ...
    if (window.__TAURI__) {
        try {
            ...
            showModal(texts[currentLang].autostartError || "Failed to update startup settings: " + error);
        }
    }
});
